...
Together, our solvers provide evidence that the fragment of compilers that involve finite domain reasoning
...
nonlinear arithmetic over parametric bitvectors, finishing the goal of a fully mechanized Bitwuzla, and tensor bitblasting.
...
but, to the best of my knowledge, has never been implemented. I therefore propose to implement
...
which suffices to model almost all behaviour of realistic imperative C-style languages.
...
basically all tensor based shape operations can be encoded efficiently as linear algebra over $\Z/2\Z$. This of course provides extremely convenient bitvector encodings.
