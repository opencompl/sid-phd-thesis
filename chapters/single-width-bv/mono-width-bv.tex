...
symbolic widths at once, e.g. truncations, zero- and sign-extensions. 
Lifting the mono-width decision procedure to the multi-width setting is the subject of the next chapter,
which shows that the many-width problem reduces with only linear blowup back to the mono-width solver developed here.
